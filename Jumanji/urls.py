...
from vacancies.views import DetailVacancyView, CustomHendler, MainView, VacanciesByCompanyView, \
    VacanciesListView, VacanciesBySpecialityView, SendVacancyView, MyCompanyCreateView, MyCompanyView, \
    Vacancy_listCompanyView, MyVacancyCreateView, MyCompanyEditView, OneVacancyByCompanyView
...
urlpatterns = [
    ...
    path('mycompany/letsstart', MyCompanyEditView.as_view(), name="company_edit"),
    ...
    path('mycompany/vacancies', Vacancy_listCompanyView.as_view(), name="company_vacancies"),
    path('mycompany/vacancies/create', MyVacancyCreateView.as_view(), name="create_vacancy"),
    path('mycompany/vacancies/<int:vacancy_id>', OneVacancyByCompanyView.as_view(), name="update_vacancy"),
